...
Requires: `agents` · `sessions` · `agentDefaultModel` · `agentPresets` · `sessionPersistence` · `timer`
...
Source: [`packages/openclaw/channel-core/src/index.ts:151`](../packages/openclaw/channel-core/src/index.ts)
...
Source: [`packages/openclaw/channel-telegram/src/index.ts:35`](../packages/openclaw/channel-telegram/src/index.ts)
