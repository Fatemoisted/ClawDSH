...
| `ctx.clawdshOpenClawControl` | `core` | `channel-openclaw` | - | - | - | Exposes secret-free lifecycle state and validates desired Settings with managed-identity and deployment preflight checks before persistence. |
