...
需要： `agents` · `agentPresets` · `sessions` · `agentDefaultModel` · `settings` · `tools`
...
来源： [`packages/openclaw/automation/src/index.ts:125`](../packages/openclaw/automation/src/index.ts)
