...
**Purpose**: Telegram channel adapter — a thin `ChannelAdapter` over grammY `Bot`: drain-aware long-polling text/caption and raster-image inbound plus retried native topic/reply/reaction outbound with Unicode-safe 4096-unit chunking.
