 ...
 * (`packages/` + `apps/`, `vendor/`, `native/`, and `packages/openclaw/`) and
...
/** Harness packages (excluding the independent ClawDSH subtree) and apps: one shared version. */
class DshFamily extends ReleaseFamily {
  readonly id = 'dsh'
  readonly patterns = ['packages/!(openclaw)/*/package.json', 'apps/*/package.json'] as const
