...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  channels: 'clawdsh.md',
  clawdshActivity: 'clawdsh.md',
  clawdshOpenClawControl: 'clawdsh.md',
  clawdshSoulSettings: 'clawdsh.md',
  ...
  legacyChannels: 'clawdsh.md',
  llm: 'llm-streaming.md',
  embeddings: 'clawdsh.md',
  lsp: 'lsp.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ChannelActionResultV1: '../../packages/openclaw/channel/README.md',
  ChannelActionV1: '../../packages/openclaw/channel/README.md',
  ChannelAdapter: '../specs/feature-channel-core.md',
  ChannelDeliveryReportV1: '../../packages/openclaw/channel/README.md',
  ChannelDriverV1: '../../packages/openclaw/channel/README.md',
  ChannelHealthV1: '../../packages/openclaw/channel/README.md',
  ChannelMessage: '../specs/feature-channel-core.md',
  ChannelProviderV1: '../../packages/openclaw/channel/README.md',
  ChannelSessionCloseV1: '../../packages/openclaw/channel/README.md',
  ChannelSessionResetResultV1: '../../packages/openclaw/channel/README.md',
  ChannelSessionResetV1: '../../packages/openclaw/channel/README.md',
  ChannelTurnCancelV1: '../../packages/openclaw/channel/README.md',
  ChannelTurnEnvelopeV1: '../../packages/openclaw/channel/README.md',
  ChannelTurnExecutionV1: '../../packages/openclaw/channel/README.md',
  ChannelTurnResultV1: '../../packages/openclaw/channel/README.md',
  ClawdshActivityHistorySources: '../../packages/openclaw/activity/README.md',
  ClawdshActivityPage: '../../packages/openclaw/activity/README.md',
  ClawdshActivityPageRequest: '../../packages/openclaw/activity/README.md',
  ClawdshActivityReadRequest: '../../packages/openclaw/activity/README.md',
  ClawdshActivityReadResult: '../../packages/openclaw/activity/README.md',
  ...
  SkillLoadedActivity: '../../packages/openclaw/activity/README.md',
  SkillInvokedActivity: '../../packages/openclaw/activity/README.md',
  AutomationRunActivity: '../../packages/openclaw/activity/README.md',
  OpenClawControlStatus: '../../packages/openclaw/channel-openclaw/README.md',
  ...
  EmbeddingVector: '../adr/0003-embeddings-seam.md',
  ...
  PresentationConfig: '../specs/feature-channel-core.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  Config: 'package-local plugin configuration types are owned by their package README and intentionally share this generic symbol name',
